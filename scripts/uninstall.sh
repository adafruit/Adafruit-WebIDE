...
# curl https://raw.github.com/adafruit/Adafruit-WebIDE/test/scripts/uninstall.sh | sudo sh
...
echo "**** sudo apt-get remove nodejs npm redis-server git restartd libcap2-bin avahi-daemon i2c-tools ipython ****"